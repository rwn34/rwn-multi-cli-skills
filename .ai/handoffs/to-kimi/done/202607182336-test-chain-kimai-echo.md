...
1. Write `.ai/reports/test-chain-kimai.md` with exactly:
   ...
   # kimai-auto marker
   - Actor: kimai-auto
   - Handoff: 202607182336-test-chain-kimai-echo
   - Written: $(date +%Y-%m-%d\ %H:%M) (UTC+7)
   ```
2. Create a return handoff in `.ai/handoffs/to-claude/open/202607182336-test-chain-kimai-return.md`
...
## Verification
- Marker file written: `.ai/reports/test-chain-kimai.md`
- Return handoff created: `.ai/handoffs/to-claude/open/202607182336-test-chain-kimai-return.md`
- Original handoff self-retired to `.ai/handoffs/to-kimi/done/`

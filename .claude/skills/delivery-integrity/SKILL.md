...
description: Rules for what counts as "done" — no placeholder/mock/stub deliverables presented as finished, verify by execution not inspection, think one step ahead, honesty about partial/blocked/failed state, insight duty, session-end continuation discipline. Activate before claiming any task complete, before writing a completion handoff or report, when tempted to stub something out, or when ending a session with unfinished work.
---

<!-- SSOT: .ai/instructions/delivery-integrity/principles.md — regenerate via .ai/sync.md -->

# Add archive-folder skip rule to Kimi's AI contract
Status: DONE
Sender: claude-code
Recipient: kimi-cli
...
## Goal
Add a short section to `.kimi/steering/00-ai-contract.md` saying that folders
...
## Current state
`.kimi/steering/00-ai-contract.md` covers identity, SSOT, activity log, and
handoffs — but says nothing about the new archive folders. Without this rule in
your always-loaded contract, a future Kimi session might scan
...
your always-loaded steering so it applies at every Kimi turn without having to
...
## Verification
- (a) `.kimi/steering/00-ai-contract.md` contains the archive-skip section.
...
## Activity log template
    ...
    - Action: Added archive-folder skip rule to .kimi/steering/00-ai-contract.md per handoff 005. Don't read .ai/**/archive/ unless user asks for historical content.

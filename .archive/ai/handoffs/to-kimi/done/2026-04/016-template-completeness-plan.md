...
`.ai/research/template-completeness-kimi.md`.
...
3. For item 10 (MCP): which MCP servers does Kimi CLI benefit from?
4. For item 11: does Kimi prefer inline prompts or file refs?
5. Any items I missed?
6. Anything Kimi-specific that should be in the template?
